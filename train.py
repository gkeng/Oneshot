...
if __name__ == '__main__':
    lfw_ds = datasets.get_dataset_lfw(path_to_lfw='/ubuntu/Oneshot/lfw', target_size=IMG_SIZE)
    olivetti_ds = datasets.get_dataset_olivetti(path_to_olivetti='/ubuntu/Oneshot/olivetti', target_size=IMG_SIZE)
