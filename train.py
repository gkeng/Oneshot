...
if __name__ == '__main__':
    lfw_ds = datasets.get_dataset_lfw(path_to_lfw='/home/gael/dev/OneShotAnson/Siamese_Networks_Face_Recognition-master/lfw', target_size=IMG_SIZE)
    olivetti_ds = datasets.get_dataset_olivetti(path_to_olivetti='/home/gael/dev/OneShotAnson/Siamese_Networks_Face_Recognition-master/att_faces', target_size=IMG_SIZE)
